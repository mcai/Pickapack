...
public class TaobaoModelCrawler extends WebCrawler {
    private String folderImages;

    public TaobaoModelCrawler(String folderImages, boolean doFaceRecognition) {
    ...
    protected void onPageVisited(Page page, Map<String, Object> context) {
        ...
        if(page instanceof HtmlPage) {
            ...
            if(url.startsWith("http://mm.taobao.com/weekly_top.htm")) {
                this.visitLinks((HtmlPage) page, "//div[@class='list-item']//div[@class='pic w610']//a[.//img]", null, false);
                this.visitLinks((HtmlPage) page, "//div[@class='page-center']//div[@class='pagination']//a[@class='page-next'][starts-with(@href,'http://mm.taobao.com/weekly_top.htm')][contains(.,'下一页')]", null, false);
            }
            else if(url.startsWith("http://mm.taobao.com/album-")) {
                Map<String, Object> context1 = new HashMap<String, Object>();
                context1.put("fromAlbum", true);
                this.visitLinks((HtmlPage) page, "//div[@class='album-item-wrap clearfix']//div[@class='album-item']//div[@class='wrap']//div[@class='pic s160']//a[.//img]", context1, false);
            }
            else if(url.startsWith("http://mm.taobao.com/photo-")) {
                if(context != null && context.containsKey("fromAlbum") && context.get("fromAlbum") == Boolean.TRUE) {
                    List<DomAttr> imageUrlAttributes = (List<DomAttr>) ((HtmlPage) page).getByXPath("//div[@class='poster-thumb J_PosterThumb']//div[@class='poster-thumb-list']//ul//a//img[@data-original-src]/@data-original-src");
                    ...
                    HtmlSpan spanName = ((HtmlPage) page).getFirstByXPath("//span[@class='tstar-name font-yahei']");
                    this.downloadDocumentByUrls(urls, FileUtils.getUserDirectoryPath() + this.folderImages + "/" + spanName.asText());
                }
                else {
                    this.visitLinks((HtmlPage) page, "//ul[@class='tstar-profile-tab']//li//a[contains(.,'相册')][.//span]", null, false);
                }
            }
        }

//        if(page instanceof HtmlPage && page.getUrl().toString().startsWith("http://vgirl.weibo.com/area.php")) {
//            this.visitLinks((HtmlPage) page, "//ul[@class='vg_short']//a[//img[@class='long_img']]");
//            this.visitLinks((HtmlPage) page, "//div[@class='W_pages W_pages_comment vg_txtb vg_linkb mini_blog_wrap noface']//a[@class='W_btn_a'][starts-with(@href,'/area.php?')][contains(.,'下一页')]");
//        }
//        else if(page instanceof HtmlPage && page.getUrl().toString().startsWith("http://vgirl.weibo.com/rank.php")) {
//            this.visitLinks((HtmlPage) page, "//ul[@class='rlist']//span[@class='shows']//a[//img[@class='vg_line']]");
//            this.visitLinks((HtmlPage) page, "//div[@class='W_pages W_pages_comment vg_txtb vg_linkb mini_blog_wrap noface']//a[@class='W_btn_a'][starts-with(@href,'/rank.php?')][contains(.,'下一页')]");
//        }
...
//                    this.visitPage((HtmlPage) page, (HtmlPage) anchorAlbum.click());
//                }
//            } catch (IOException e) {
...
//
//            if(!urls.isEmpty()) {
//                this.visitLinks((HtmlPage) page, "//div[@id='photo_page']//a[@class='vg_linkb vg_line next'][starts-with(@href,'show.php?')][contains(.,'下一页')]");
//            }
//        }
//        else if(page instanceof HtmlPage && page.getUrl().toString().startsWith("http://vgirl.weibo.com/")) {
//            try {
//                this.visitPage((HtmlPage) page, (HtmlPage) ((HtmlPage) page).<HtmlAnchor>getFirstByXPath("//div[@class='vg_navbox']//li//a[contains(.,'个人资料')]").click());
//                this.visitPage((HtmlPage) page, (HtmlPage) ((HtmlPage) page).<HtmlAnchor>getFirstByXPath("//div[@class='vg_navbox']//li//a[contains(.,'相册')]").click());
//            } catch (IOException e) {
//                throw new RuntimeException(e);
//            }
//        }
    ...
    public static void main(String[] args) {
        TaobaoModelCrawler spider = new TaobaoModelCrawler("/OOXXPicsSpider/taobaoModel", false);
//        spider.setProxy("10.26.27.29", 3128);

        spider.visit("http://mm.taobao.com/weekly_top.htm");
    }
}
