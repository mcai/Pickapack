...
public class FileReactorDownloader extends MediaFileDownloader {
    public FileReactorDownloader(NoJSCrawler crawler) {
        super(HOST, crawler);
    }
    ...
    public void doDownloadMediaFile(String storageFolder, URL url) {
        try {
            ...
            String op = page.getFirstByXPath("//div[@id='content']//form//input[@name='op']//@value").getNodeValue();
            String usrLogin = page.getFirstByXPath("//div[@id='content']//form//input[@name='usr_login']//@value").getNodeValue();
            String id = page.getFirstByXPath("//div[@id='content']//form//input[@name='id']//@value").getNodeValue();
            String fname = page.getFirstByXPath("//div[@id='content']//form//input[@name='fname']//@value").getNodeValue();
            String referer = page.getFirstByXPath("//div[@id='content']//form//input[@name='referer']//@value").getNodeValue();
            ...
            String op2 = page.getFirstByXPath("//div[@class='wrap']//form//input[@name='op']//@value").getNodeValue();
            String id2 = page.getFirstByXPath("//div[@class='wrap']//form//input[@name='id']//@value").getNodeValue();
            String rand2 = page.getFirstByXPath("//div[@class='wrap']//form//input[@name='rand']//@value").getNodeValue();
            String referer2 = page.getFirstByXPath("//div[@class='wrap']//form//input[@name='referer']//@value").getNodeValue();
            ...
            if (captcha != null) {
                ...
                requestParameters2.add(new BasicNameValuePair("method_free", "Regular Download"));
                ...
                requestParameters2.add(new BasicNameValuePair("down_direct", "1"));

                Page pageMedia = this.getCrawler().getPage(url, HttpMethod.POST, requestParameters2, null, null);
                Node nodeDownloadLink = pageMedia.getFirstByXPath("//a[@title='Download link']/@href");
                if (nodeDownloadLink != null) {
                    String location = nodeDownloadLink.getNodeValue();
                    String hashedUrl = this.getCrawler().getHashedUrl(location);
                    File localFile = new File(storageFolder, fname);
    ...
    public static final String HOST = "www.filereactor.com";
}
